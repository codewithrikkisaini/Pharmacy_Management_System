<div class="pb-20">
    <!-- Header Section -->
    <div class="bg-indigo-600 pt-32 pb-20 text-white relative overflow-hidden text-center">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        <div class="glass p-8 rounded-[40px] mb-12 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl border-2 border-indigo-50">
            <div class="relative w-full md:w-96">
                <input type="text" wire:model.live="search" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm focus:ring-2 focus:ring-indigo-500 font-bold" placeholder="Search by name or specialization...">
            ...
            <div class="glass group rounded-[40px] overflow-hidden hover:shadow-2xl transition-all duration-500 flex flex-col h-full border-2 border-transparent hover:border-indigo-50">
                <div class="h-80 overflow-hidden relative">
                    ...
                    <div class="absolute bottom-6 left-6 right-6 p-4 glass rounded-3xl backdrop-blur-md border border-white/30 translate-y-20 group-hover:translate-y-0 transition-transform duration-500">
                        <div class="text-[10px] font-black text-indigo-600 uppercase tracking-widest mb-1">Availability</div>
                ...
                <div class="p-8 space-y-4 flex flex-col flex-1 text-center">
                    <div class="text-[10px] font-black text-indigo-600 uppercase tracking-[0.2em]">{{ $doctor->specialization }}</div>
                    ...
                    <div class="pt-6 mt-auto">
                        <button class="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black text-sm shadow-xl shadow-indigo-200 dark:shadow-none hover:bg-indigo-700 transition-all">
                            Book Appointment
                        </button>
                    </div>
                </div>
