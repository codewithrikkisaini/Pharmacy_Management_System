                ...
                <div class="glass p-10 rounded-[40px] space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="phone" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-bold focus:ring-2 focus:ring-emerald-500" placeholder="+1 (555) 000-0000">
                    ...
                    <div>
                        ...
                        <textarea wire:model="address" rows="4" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-bold focus:ring-2 focus:ring-emerald-500" placeholder="Enter your full street address..."></textarea>
                    ...
                    <div class="pt-8 border-t">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <label class="relative flex items-center p-6 glass rounded-3xl cursor-pointer hover:border-emerald-500 transition-all border-2 {{ $payment_method == 'cash' ? 'border-emerald-500 bg-emerald-50/50' : 'border-transparent' }}">
                            ...
                            <label class="relative flex items-center p-6 glass rounded-3xl cursor-pointer hover:border-emerald-500 transition-all border-2 {{ $payment_method == 'online' ? 'border-emerald-500 bg-emerald-50/50' : 'border-transparent' }}">
                ...
                <div class="glass p-8 rounded-[40px]">
                    ...
                    <div class="space-y-6 mb-8">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <p class="font-black text-sm text-emerald-600">${{ number_format($item['price'] * $item['quantity'], 2) }}</p>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <button wire:click="placeOrder" class="w-full mt-8 bg-emerald-600 text-white px-8 py-4 rounded-2xl font-bold shadow-lg shadow-emerald-200 hover:bg-emerald-700 transition-all">Confirm Order</button>
                </div>
