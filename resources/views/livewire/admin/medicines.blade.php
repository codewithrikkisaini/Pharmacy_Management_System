<div class="space-y-8">
    <div class="flex items-center justify-between">
        ...
        <button wire:click="openModal" class="bg-sky-500 hover:bg-sky-600 text-white px-8 py-3.5 rounded-2xl font-bold transition-all shadow-lg shadow-sky-100 flex items-center">
    ...
    <div class="bg-white rounded-[32px] card-shadow overflow-hidden">
        <div class="p-8 border-b border-slate-50 flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="relative w-full md:w-96">
                <input type="text" wire:model.live="search" placeholder="Search medicines..." class="bg-slate-50 border-none rounded-xl px-5 py-3 text-sm w-full focus:ring-2 focus:ring-sky-500 transition-all">
            ...
            <div class="flex items-center space-x-2">
                ...
                <select class="bg-slate-50 border-none rounded-xl px-4 py-2 text-xs font-bold focus:ring-2 focus:ring-sky-500">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/30 transition-colors group">
                        <td class="px-8 py-5">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <div class="text-[10px] font-bold text-sky-500 uppercase tracking-widest mt-0.5">{{ $medicine->type }}</div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-8 py-5 text-right space-x-2">
                            <button wire:click="edit({{ $medicine->id }})" class="text-sky-600 hover:text-sky-700 font-bold text-sm bg-sky-50 px-4 py-2 rounded-xl transition-all">Edit</button>
    ...
    <div class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
        <div class="bg-white w-full max-w-2xl rounded-[40px] shadow-2xl overflow-hidden transform transition-all">
            ...
            <form wire:submit.prevent="save" class="p-10 grid grid-cols-2 gap-8">
                <div class="col-span-2">
                    <label class="block text-sm font-black text-slate-700 mb-3 uppercase tracking-widest">Product Name</label>
                    <input type="text" wire:model="name" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-sky-500 font-medium" placeholder="e.g. Paracetamol 500mg">
                ...
                <div>
                    ...
                    <select wire:model="category_id" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-sky-500 font-bold">
                ...
                <div>
                    ...
                    <select wire:model="type" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-sky-500 font-bold">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" wire:model="price" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-sky-500 font-bold">
                ...
                <div>
                    ...
                    <input type="number" wire:model="stock" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-sky-500 font-bold">
                ...
                <div class="col-span-2">
                    ...
                    <textarea wire:model="description" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-sky-500 font-medium" rows="3" placeholder="Medicine details, dosage, etc."></textarea>
                    @error('description') <span class="text-red-500 text-xs font-bold mt-2 block">{{ $message }}</span> @enderror
                </div>

                <div class="col-span-2 pt-6">
                    <button type="submit" class="w-full bg-sky-500 hover:bg-sky-600 text-white font-black py-5 rounded-2xl shadow-xl shadow-sky-100 transition-all transform hover:scale-[1.01]">
